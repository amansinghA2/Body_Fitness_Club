//
//  BFCDayPlanExercisesViewController.swift
//  BFC
//
...
class BFCDayPlanExercisesViewController: BFCBaseViewController {
...
extension BFCDayPlanExercisesViewController: UITableViewDataSource , UITableViewDelegate {
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        performSegueWithIdentifier("WorkoutExcDescIdentifier", sender: nil)
    }
